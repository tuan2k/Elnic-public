          ...
          <div class="row">
            ...
            <div class="col-md-7 col-md-text-right">
              <div class="entry">
                ...
                <a href="#" @click="onClickLogin">login</a>
                              ...
                              <div class="product-shortcode style-5">
                                ...
                                <div class="preview">
                                  <div class="swiper-container" data-loop="1">
                                    <div
                                      class="swiper-button-prev style-1"
                                    ></div>
                                    <div
                                      class="swiper-button-next style-1"
                                    ></div>
                                ...
                                <div class="valign-middle-cell">
                                  <div class="valign-middle-content">
                                    <div
                                      ...
                                      "
                                    >
                                      <span class="color">30%</span>DISCOUNT
                                    </div>
                                    <h3 class="h3 light col-xs-b15">
                                    ...
                                    <div
                                      ...
                                      "
                                    >
                                      Vivamus in tempor eros. Phasellus rhoncus
                                      in nunc sit amet mattis. Integer in ipsum
                                      vestibulum, molestie arcu ac
                                    </div>
                ...
                <div class="product-preview-shortcode">
                  <div class="preview">
                    ...
                    <div
                      ...
                      data-background="img/product-preview-1.jpg"
                    ></div>
                    <div
                      class="entry full-size swiper-lazy"
                      data-background="img/product-preview-2.jpg"
                    ></div>
                    <div
                      class="entry full-size swiper-lazy"
                      data-background="img/product-preview-3.jpg"
                    ></div>
                  </div>
                  <div
