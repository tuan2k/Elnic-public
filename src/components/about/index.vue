        ...
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3">
            <div class="cell-view simple-banner-height text-center">
              ...
              <h1 class="h1 light" style="color: black">we are elnic</h1>
              <div class="title-underline center"><span /></div>
              <div
                class="simple-article light transparent size-4"
                style="color: black"
              >
                where your business begin to Infinitives, and Beyond!
              </div>
              <div class="empty-space col-xs-b35 col-sm-b70" />
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <div class="simple-article size-4 grey">
            ...
            lorem. Donec quis arcu elit. In vehicula purus sem
          </div>
        </div>
        <div class="col-sm-7">
              ...
              <div class="icon-description-shortcode style-2">
                ...
                <div class="content">
                  ...
                  <div class="description simple-article size-2">
                    ...
                    lacus sollicitudin facilisis. Lorem ipsum dolor sit amet
                    semper ante vehicula
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="product-shortcode style-9">
                ...
                <div class="content">
                  <div class="title">
                    <div
                      class="simple-article size-1 uppercase color col-xs-b5"
                    >
                      co-founder
                    </div>
