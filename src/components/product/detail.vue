        ...
        <div class="col-md-9 col-md-push-3">
          <div class="row">
            <div class="col-sm-6 col-xs-b30 col-sm-b0">
              <img
                :src="this.form.productThambnail"
                height="400px"
                weight="400px"
              />
            ...
            <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="simple-article size-3 col-xs-b5">
                    ITEM NO.: <span class="grey">127-#5238</span>
                  </div>
                </div>
                <div class="col-sm-6 col-sm-text-right">
                  <div class="simple-article size-3 col-xs-b20">
                    AVAILABLE.:
              ...
              <div class="simple-article size-3 col-xs-b30">
                Vivamus in tempor eros. Phasellus rhoncus in nunc sit amet
                mattis. Integer in ipsum vestibulum, molestie arcu ac, efficitur
                tellus. Phasellus id vulputate erat.
              </div>
              ...
              <div class="row m5 col-xs-b40">
                <div class="col-sm-6 col-xs-b10 col-sm-b0">
                  <p
                    class="button size-2 style-2 block"
                    v-on:click="addToCart(form)"
                  >
        ...
        if (result.isConfirmed) {
          axios
            ...
            .then(data => {
              ...
              this.$swal({
                title: "Delete comment succesfully!",
                icon: "success",
                toast: true,
                position: "top-end",
                showConfirmButton: false,
